...
<template>
  <div>
    <section>
      <div class="mt-8 col-xl-5 col-lg-6 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-auto">
          ...
          <div class="card-body">
            ...
            <form id="contact-form" method="post" autocomplete="off">
              <div class="card-body p-0 my-3">
                ...
                <!-- 이메일 수정 모드 -->
                <MaterialInput v-else class="input-group-static mb-4" label="이메일" type="email" v-model="emailInput" />
                <hr>
                <!-- 성별 조회 모드 -->
                ...
                <div class="pb-3" v-else>
                  ...
                  <div>
                    <label id="radio">
                      <input type="radio" name="gender" value="1" v-model="genderInput" />
                      male
                    </label>
                    <label id="radio">
                      <input type="radio" name="gender" value="2" v-model="genderInput" />
                      female
                    </label>
                  </div>
                </div>
                <div class="col-md-12 text-center">
                  <!-- 저장 모드 버튼 -->
                  <MaterialButton variant="gradient" color="success" class="mt-3 mb-0" @click.prevent="saveChanges">
                    저장
                  </MaterialButton>
                </div>
              </div>
